...
def main() -> None:
    ...
    # TD3 keşif için aksiyon gürültüsü kullanır (SAC'ın entropi yerine)
    ...
    model = TD3(
        ...
        policy_delay=2,           # aktörü her 2 kritik güncellemede 1 güncelle
        target_policy_noise=0.2,  # hedef politikaya gürültü — overfit önler
