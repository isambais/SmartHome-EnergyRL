"""TD3 egitimi — Phase 1, saf batarya arbitraji (56 boyut obs)."""
...
LOG_DIR   = _PROJECT_ROOT / "logs" / "td3_phase1"
...
def main() -> None:
    ...
    eval_callback = EvalCallback(
        eval_env,
        best_model_save_path=str(MODEL_DIR / "td3_phase1_best"),
    ...
    print("TD3 Phase 1 egitimi basliyor (500.000 adim, CPU)...")
    ...
    model.save(str(MODEL_DIR / "td3_smarthome_final"))
    train_env.save(str(MODEL_DIR / "td3_vecnormalize.pkl"))
    print(f"Model kaydedildi: {MODEL_DIR / 'td3_smarthome_final'}")
