"""Optuna hiperparametre araması — SAC, Curriculum Aşama 3 (ertelenebilir yük).

Kullanım:
    python scripts/hpo/sac_phase3.py

Sonuçlar:
    logs/optuna_sac_phase3.db
"""
...
def main() -> None:
    study = optuna.create_study(
        direction="maximize",
        study_name="phase3_sac_optuna",
        storage=f"sqlite:///{_PROJECT_ROOT}/logs/optuna_sac_phase3.db",
        load_if_exists=True,
    ...
    print(f"\n{'='*50}")
    print(f"SAC Phase 3 — En iyi trial: #{study.best_trial.number}")
